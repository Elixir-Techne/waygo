...
django.setup()
from main.models import Company, Lot, LotData
...
def generate_mockup_data(chamber):
    ...
    time_range_start = timezone.make_aware(datetime(2023, 1, 1, 1, 0, 0), timezone.get_default_timezone())
    time_range_end = timezone.make_aware(datetime(2024, 2, 1, 1, 0, 0), timezone.get_default_timezone())
...
def start_generate():
    ...
    for i in range(1, 21):
        generate_mockup_data(i)
        print("Mock-up data for chamber " + str(i) + " created")
